    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h2 class="modal-title fs-5" id="exampleModalLabel">ADD REAGENT</h2>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form action="/save-reagents" method="POST">
            {{ csrf_field() }}
          ...
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
            ...
            <form id="delete_modal_Form" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <h5>Are you sure you want to delete this Reagent ?</h5>
                </div>
                <div class="modal-footer">
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">REAGENT SETUP
          ...
          <div class="table-responsive">
            <table id="datatable" class="table">
              <thead class=" text-primary">
                <th class="w-10p">ID Reagent</th>
                <th class="w-10p">Reagent Name</th>
              ...
              <tbody>
                ...
                <a href="{{ url('reagents/'.$data->id)}}" class="btn btn-success">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#datatable').on('click', '.deletebtn', function () {
                ...
                $('#delete_modal_Form').attr('action', '/reagents-delete/'+data[0]);
