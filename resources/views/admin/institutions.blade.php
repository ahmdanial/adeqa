    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h2 class="modal-title fs-5" id="exampleModalLabel">ADD INSTITUTION</h2>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form action="/save-institutions" method="POST">
            {{ csrf_field() }}
        ...
        <div class="modal-header">
          ...
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
            ...
            <form id="delete_modal_Form" method="POST">
                ...
                <div class="modal-body">
                    <input type="hidden" id="delete_institutions_id">
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">INSTITUTION SETUP
          ...
          <div class="table-responsive">
            <table id="datatable" class="table">
              <thead class=" text-primary">
                <th class="w-10p">Institution ID</th>
              ...
              <tbody>
                ...
                <a href="{{ url('institutions/'.$data->id)}}" class="btn btn-success">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#datatable').on('click', '.deletebtn', function () {
                ...
                $('#delete_modal_Form').attr('action', '/institutions-delete/'+data[0]);
